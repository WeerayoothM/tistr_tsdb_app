  ...
  return (
    ...
    >
      ...
      <div className="font-srb-500 flex items-center justify-end gap-[2rem] mt-[2rem]">
        <div className="text-[#FFA500] text-[16px] cursor-pointer">
          {"ดูโครงการทั้งหมด >"}
        </div>
        <div
          className="bg-[#FFA500] text-white text-[20px] py-[1rem] px-[3rem] cursor-pointer rounded-[8px]"
          onClick={() =>
            navigate("/project/outbdg-result", { state: formData })
          }
        >
          ค้นหา
        </div>
